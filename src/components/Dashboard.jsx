...
function Dashboard({ user }) {
  ...
  const fetchData = async () => {
    try {
      ...
      const weatherResponse = await axios.get(`https://api.open-meteo.com/v1/forecast?latitude=${currentLocation.lat}&longitude=${currentLocation.lon}&current=temperature_2m,weather_code&timezone=auto`)
  ...
  const fetchWeatherForLocation = async (location) => {
    try {
      ...
      const weatherResponse = await axios.get(`https://api.open-meteo.com/v1/forecast?latitude=${location.lat}&longitude=${location.lon}&current=temperature_2m,weather_code&timezone=auto`)
      const weatherData = weatherResponse.data
